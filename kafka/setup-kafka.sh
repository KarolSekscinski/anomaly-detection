...
kafka-topics --bootstrap-server kafka-broker:29092 --create --if-not-exists --topic stocks --replication-factor 1 --partitions 1
kafka-topics --bootstrap-server kafka-broker:29092 --create --if-not-exists --topic anomalies --replication-factor 1 --partitions 1
